...
//
//
//    // ------------------- JPQL QUERIES ---------  use entity/class names  ---------- //
//
//
//    //Write a JPQL query that returns all accounts
//    @Query("SELECT a FROM Account a ")              // use object name instead of * // each line of table is an object
//    List<Account> fetchAllJPQL();   //name is not important
//
//    //Write a JPQL query to list all admin accounts
//    @Query("SELECT a FROM Account a WHERE a.role ='ADMIN'")  //should be user as written in the data.sql
...
//
//
//    // ------------------- Native QUERIES --------- use table names ----- //
//
//    //Write a native query to read all accounts with an age lower than a specific value
//    @Query(value = "SELECT * FROM account_details WHERE age < ?1",nativeQuery = true) //( age <20 ) or ( age < :age )
